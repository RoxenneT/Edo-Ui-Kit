...
.tw-edo-document-container {
  @apply max-w-[823px] h-[188px] flex flex-row justify-center items-center
}
...
.tw-subtitle {
  @apply text-[#246488] leading-4 text-xs mb-1
}
